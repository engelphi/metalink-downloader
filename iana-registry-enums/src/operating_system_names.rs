...
mod tests {
    ...
    static OS_NAMES: Lazy<Vec<(&'static str, OperatingSystemName)>> = Lazy::new(|| {
        vec![
            ("AEGIS", OperatingSystemName::Aegis),
            ("AIX-PS/2", OperatingSystemName::AixPs2),
            ("AIX/370", OperatingSystemName::Aix370),
            ("AMIGA-OS-1.2", OperatingSystemName::AmigaOS1_2),
            ("AMIGA-OS-1.3", OperatingSystemName::AmigaOS1_3),
            ("AMIGA-OS-2.0", OperatingSystemName::AmigaOS2_0),
            ("AMIGA-OS-2.1", OperatingSystemName::AmigaOS2_1),
            ("AMIGA-OS-3.0", OperatingSystemName::AmigaOS3_0),
            ("AMIGA-OS-3.1", OperatingSystemName::AmigaOS3_1),
            ("AMIGA-OS-3.5", OperatingSystemName::AmigaOS3_5),
            ("AMIGA-OS-3.9", OperatingSystemName::AmigaOS3_9),
            ("APOLLO", OperatingSystemName::Apollo),
            ("BEOS-4.5.2", OperatingSystemName::BeOS4_5_2),
            ("BEOS-5.0", OperatingSystemName::BeOS5_0),
            ("BS-2000", OperatingSystemName::BS2000),
            ("CEDAR", OperatingSystemName::Cedar),
            ("CGW", OperatingSystemName::CGW),
            ("CHORUS", OperatingSystemName::Chorus),
            ("CHRYSALIS", OperatingSystemName::Chrysalis),
            ("CMOS", OperatingSystemName::CMOS),
            ("CMS", OperatingSystemName::CMS),
            ("COS", OperatingSystemName::COS),
            ("CPIX", OperatingSystemName::CPIX),
            ("CTOS", OperatingSystemName::CTOS),
            ("CTSS", OperatingSystemName::CTSS),
            ("CYGWIN", OperatingSystemName::CYGWIN),
            ("DCN", OperatingSystemName::DCN),
            ("DDNOS", OperatingSystemName::DDNOS),
            ("DOMAIN", OperatingSystemName::DOMAIN),
            ("DOS", OperatingSystemName::DOS),
            ("ECOS", OperatingSystemName::ECOS),
            ("ECOSPRO", OperatingSystemName::ECOSPRO),
            ("EDX", OperatingSystemName::EDX),
            ("ELF", OperatingSystemName::ELF),
            ("EMBOS", OperatingSystemName::EMBOS),
            ("EMMOS", OperatingSystemName::EMMOS),
            ("EPOS", OperatingSystemName::EPOS),
            ("FOONEX", OperatingSystemName::FOONEX),
            ("FORTH", OperatingSystemName::FORTH),
            ("FREEBSD", OperatingSystemName::FREEBSD),
            ("FUZZ", OperatingSystemName::FUZZ),
            ("GCOS", OperatingSystemName::GCOS),
            ("GPOS", OperatingSystemName::GPOS),
            ("HDOS", OperatingSystemName::HDOS),
            ("IMAGEN", OperatingSystemName::IMAGEN),
            ("IMPRESS", OperatingSystemName::IMPRESS),
            ("INSTANT-INTERNET", OperatingSystemName::InstantInternet),
            ("INTERCOM", OperatingSystemName::INTERCOM),
            ("INTERLISP", OperatingSystemName::INTERLISP),
            ("IOS", OperatingSystemName::IOS),
            ("IRIX", OperatingSystemName::IRIX),
            ("ISI-68020", OperatingSystemName::ISI68020),
            ("ITS", OperatingSystemName::ITS),
            ("KOSOS", OperatingSystemName::KOSOS),
            ("LINUX", OperatingSystemName::Linux),
            ("LINUX-1.0", OperatingSystemName::Linux1_0),
            ("LINUX-1.2", OperatingSystemName::Linux1_2),
            ("LINUX-2.0", OperatingSystemName::Linux2_0),
            ("LINUX-2.2", OperatingSystemName::Linux2_2),
            ("LINUX-2.4", OperatingSystemName::Linux2_4),
            ("LINUX-2.6", OperatingSystemName::Linux2_6),
            ("LISP", OperatingSystemName::LISP),
            ("LISPM", OperatingSystemName::LISPM),
            ("LOCUS", OperatingSystemName::LOCUS),
            ("MACOS", OperatingSystemName::MacOS),
            ("MINOS", OperatingSystemName::MINOS),
            ("MOS", OperatingSystemName::MOS),
            ("MPE/IX", OperatingSystemName::MpeIx),
            ("MPE/V", OperatingSystemName::MpeV),
            ("MPE5", OperatingSystemName::Mpe5),
            ("MSDOS", OperatingSystemName::MsDOS),
            ("MULTICS", OperatingSystemName::Multics),
            ("MUSIC", OperatingSystemName::Music),
            ("MUSIC/SP", OperatingSystemName::MusicSP),
            ("MVS", OperatingSystemName::Mvs),
            ("MVS/SP", OperatingSystemName::MvsSP),
            ("NETBSD-1.0", OperatingSystemName::NetBSD1_0),
            ("NETBSD-1.1", OperatingSystemName::NetBSD1_1),
            ("NETBSD-1.2", OperatingSystemName::NetBSD1_2),
            ("NETBSD-1.3", OperatingSystemName::NetBSD1_3),
            ("NETWARE-3", OperatingSystemName::Netware3),
            ("NETWARE-3.11", OperatingSystemName::Netware3_11),
            ("NETWARE-4.0", OperatingSystemName::Netware4_0),
            ("NETWARE-4.1", OperatingSystemName::Netware4_1),
            ("NETWARE-5.0", OperatingSystemName::Netware5_0),
            ("NEXUS", OperatingSystemName::Nexus),
            ("NMS", OperatingSystemName::NMS),
            ("NONSTOP", OperatingSystemName::NonStop),
            ("NOS-2", OperatingSystemName::NOS2),
            ("NTOS", OperatingSystemName::NTOS),
            ("OPENBSD", OperatingSystemName::OpenBSD),
            ("OPENVME", OperatingSystemName::OpenVME),
            ("OPENVMS", OperatingSystemName::OpenVMS),
            ("OS/2", OperatingSystemName::Os2),
            ("OS/DDP", OperatingSystemName::OsDDP),
            ("OS4", OperatingSystemName::Os4),
            ("OS86", OperatingSystemName::Os86),
            ("OSX", OperatingSystemName::OSX),
            ("PCDOS", OperatingSystemName::PCDOS),
            ("PERQ/OS", OperatingSystemName::PerqOs),
            ("PLI", OperatingSystemName::PLI),
            ("PRIMOS", OperatingSystemName::PRIMOS),
            ("PSDOS/MIT", OperatingSystemName::PsdosMit),
            ("PSOS", OperatingSystemName::PSOS),
            ("RISC-OS", OperatingSystemName::RiscOS),
            ("RISC-OS-3.10", OperatingSystemName::RiscOS3_10),
            ("RISC-OS-3.50", OperatingSystemName::RiscOS3_50),
            ("RISC-OS-3.60", OperatingSystemName::RiscOS3_60),
            ("RISC-OS-3.70", OperatingSystemName::RiscOS3_70),
            ("RISC-OS-4.00", OperatingSystemName::RiscOS4_00),
            ("RMX/RDOS", OperatingSystemName::RmxRDOS),
            ("ROS", OperatingSystemName::ROS),
            ("RSX11M", OperatingSystemName::RSX11M),
            ("RTE-A", OperatingSystemName::RteA),
            ("SATOPS", OperatingSystemName::SATOPS),
            (
                "SCO-OPEN-DESKTOP-1.0",
                OperatingSystemName::ScoOpenDesktop1_0,
            ),
            (
                "SCO-OPEN-DESKTOP-1.1",
                OperatingSystemName::ScoOpenDesktop1_1,
            ),
            (
                "SCO-OPEN-DESKTOP-2.0",
                OperatingSystemName::ScoOpenDesktop2_0,
            ),
            (
                "SCO-OPEN-DESKTOP-3.0",
                OperatingSystemName::ScoOpenDesktop3_0,
            ),
            (
                "SCO-OPEN-DESKTOP-LITE-3.0",
                OperatingSystemName::ScoOpenDesktopLite3_0,
            ),
            ("SCO-OPEN-SERVER-3.0", OperatingSystemName::ScoOpenServer3_0),
            ("SCO-UNIX-3.2.0", OperatingSystemName::ScoUnix3_2_0),
            ("SCO-UNIX-3.2V2.0", OperatingSystemName::ScoUnix3_2V2_0),
            ("SCO-UNIX-3.2V2.1", OperatingSystemName::ScoUnix3_2V2_1),
            ("SCO-UNIX-3.2V4.0", OperatingSystemName::ScoUnix3_2V4_0),
            ("SCO-UNIX-3.2V4.1", OperatingSystemName::ScoUnix3_2V4_1),
            ("SCO-UNIX-3.2V4.2", OperatingSystemName::ScoUnix3_2V4_2),
            (
                "SCO-XENIX-386-2.3.2",
                OperatingSystemName::ScoXenix386_2_3_2,
            ),
            (
                "SCO-XENIX-386-2.3.3",
                OperatingSystemName::ScoXenix386_2_3_3,
            ),
            (
                "SCO-XENIX-386-2.3.4",
                OperatingSystemName::ScoXenix386_2_3_4,
            ),
            ("SCS", OperatingSystemName::SCS),
            ("SIMP", OperatingSystemName::Simp),
            ("SINIX", OperatingSystemName::Sinix),
            ("SUN", OperatingSystemName::Sun),
            ("SUN-OS-3.5", OperatingSystemName::SunOs3_5),
            ("SUN-OS-4.0", OperatingSystemName::SunOs4_0),
            ("SWIFT", OperatingSystemName::Swift),
            ("TAC", OperatingSystemName::TAC),
            ("TANDEM", OperatingSystemName::Tandem),
            ("TENEX", OperatingSystemName::Tenex),
            ("THE-MAJOR-BBS", OperatingSystemName::TheMajorBBS),
            ("TOPS10", OperatingSystemName::Tops10),
            ("TOPS20", OperatingSystemName::Tops20),
            ("TOS", OperatingSystemName::TOS),
            ("TP3010", OperatingSystemName::TP3010),
            ("TRSDOS", OperatingSystemName::TRSDOS),
            ("ULTRIX", OperatingSystemName::Ultrix),
            ("UNIX", OperatingSystemName::Unix),
            ("UNIX-BSD", OperatingSystemName::UnixBSD),
            ("UNIX-PC", OperatingSystemName::UnixPC),
            ("UNIX-V", OperatingSystemName::UnixV),
            ("UNIX-V.1", OperatingSystemName::UnixV1),
            ("UNIX-V.2", OperatingSystemName::UnixV2),
            ("UNIX-V.3", OperatingSystemName::UnixV3),
            ("UNIX-V1AT", OperatingSystemName::UnixV1AT),
            ("UNKNOWN", OperatingSystemName::Unknown),
            ("UT2D", OperatingSystemName::UT2D),
            ("V", OperatingSystemName::V),
            ("VM", OperatingSystemName::VM),
            ("VM/370", OperatingSystemName::VM370),
            ("VM/CMS", OperatingSystemName::VMCMS),
            ("VM/SP", OperatingSystemName::VMSP),
            ("VMS", OperatingSystemName::VMS),
            ("VMS/EUNICE", OperatingSystemName::VMSEunice),
            ("VRTX", OperatingSystemName::VRTX),
            ("WAITS", OperatingSystemName::Waits),
            ("WANG", OperatingSystemName::Wang),
            ("WIN32", OperatingSystemName::Win32),
            ("WINDOWS-95", OperatingSystemName::Windows95),
            ("WINDOWS-95-OSR1", OperatingSystemName::Windows95OSR1),
            ("WINDOWS-95-OSR2", OperatingSystemName::Windows95OSR2),
            ("WINDOWS-98", OperatingSystemName::Windows98),
            ("WINDOWS-CE", OperatingSystemName::WindowsCE),
            ("WINDOWS-NT", OperatingSystemName::WindowsNT),
            ("WINDOWS-NT-2", OperatingSystemName::WindowsNT2),
            ("WINDOWS-NT-3", OperatingSystemName::WindowsNT3),
            ("WINDOWS-NT-3.5", OperatingSystemName::WindowsNT3_5),
            ("WINDOWS-NT-3.51", OperatingSystemName::WindowsNT3_51),
            ("WINDOWS-NT-4", OperatingSystemName::WindowsNT4),
            ("WINDOWS-NT-5", OperatingSystemName::WindowsNT5),
            ("WINDOWS-NT-5.1", OperatingSystemName::WindowsNT5_1),
            ("WINDOWS-NT-6", OperatingSystemName::WindowsNT6),
            ("WINDOWS-NT-6.1", OperatingSystemName::WindowsNT6_1),
            ("WORLDGROUP", OperatingSystemName::WorldGroup),
            ("WYSE-WYXWARE", OperatingSystemName::WyseWyxware),
            ("X11R3", OperatingSystemName::X11R3),
            ("XDE", OperatingSystemName::XDE),
            ("XENIX", OperatingSystemName::Xenix),
        ]
    });

    #[test]
    fn test_from_str() {
        for (name_str, name_enum) in OS_NAMES.iter() {
            assert_eq!(Ok(*name_enum), name_str.parse::<OperatingSystemName>());
        }
        assert_eq!(
            Err(IANARegistryError::OsNameParseError),
            "xyz".parse::<OperatingSystemName>()
        );
    }
    ...
    fn test_try_from() {
        for (name_str, name_enum) in OS_NAMES.iter() {
            assert_eq!(Ok(*name_enum), OperatingSystemName::try_from(*name_str));
        }
        assert_eq!(
            Err(IANARegistryError::OsNameParseError),
            OperatingSystemName::try_from("xyz")
        );
    }
    ...
    fn test_from_for_str() {
        for (name_str, name_enum) in OS_NAMES.iter() {
            let result: &'static str = From::<OperatingSystemName>::from(*name_enum);
